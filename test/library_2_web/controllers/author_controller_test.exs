defmodule Library2Web.AuthorControllerTest do
  use Library2Web.ConnCase

  alias Library2.Test

  @create_attrs %{biography: "some biography", birthdate: ~D[2010-04-17], name: "some name"}
  ...
  def fixture(:author) do
    {:ok, author} = Test.create_author(@create_attrs)
    author
  end
  ...
  describe "update author" do
    ...
    test "redirects when data is valid", %{conn: conn, author: author} do
      ...
      assert html_response(conn, 200) =~ "some updated biography"
    end
