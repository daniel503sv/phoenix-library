defmodule LibraryWeb.BookControllerTest do
  ...
  @create_attrs %{edition: "some edition", summary: "some summary", title: "some title"}
  ...
  def fixture(:book) do
    {:ok, book} = Site.create_book(@create_attrs)
    book
  end
  ...
  describe "update book" do
    ...
    test "redirects when data is valid", %{conn: conn, book: book} do
      ...
      assert html_response(conn, 200) =~ "some updated edition"
    end
